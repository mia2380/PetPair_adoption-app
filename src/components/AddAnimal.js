...
export default class AddAnimal extends React.Component {
    ...
    render() {
        return (
            <div>
                <img className="sad-pup" src={require('../assets/images/bg3.jpeg')}
                    alt="Puppy in shelter"
                    style={{ width: "100vw", height: "40vh", objectFit: "cover" }} />
                <div className='container-fluid content-container'>
                    <div className='add-content'>
                        <h3>Add a pet for adoption or fostering</h3>
                        <p>Listing your pet on our website will help increase the chances of them finding their furever home!</p>
