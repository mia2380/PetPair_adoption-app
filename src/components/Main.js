...
class Main extends React.Component {
  ANIMALS_API_URL = "https://petpair-express.onrender.com/animals";
  COMMENTS_API_URL = "https://petpair-express.onrender.com/comments";
  ...
  renderPage = () => {
    if (this.state.active === "home") {
      ...
      return (
        <BrowseAndSearch
          ANIMALS_API_URL={this.ANIMALS_API_URL}
      ...
      return <AddAnimal ANIMALS_API_URL={this.ANIMALS_API_URL} setActive={this.setActive} processAddNewAnimal={this.processAddNewAnimal} />;
